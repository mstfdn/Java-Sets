...
public class TaskData {
    private Set<Task> annsTasks; // Alan adı "annsTasks" olarak değiştirildi
    private Set<Task> bobsTasks; // Alan adı "bobsTasks" olarak değiştirildi
    private Set<Task> carolsTasks; // Alan adı "carolsTasks" olarak değiştirildi
    private Set<Task> unassignedTasks; // Alan adı "unassignedTasks" olarak değiştirildi
